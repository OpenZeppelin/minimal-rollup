...
# SEND SIGNAL   
cast send ${ADDRESS} 'sendSignal(bytes32)' \
...
RESPONSE=$(
    curl -s http://localhost:8545 -X POST -H "Content-Type: application/json" \
        --data '{"method":"eth_getBlockByNumber","params":["0x3",false],"id":1,"jsonrpc":"2.0"}'
    )
...
# GET PROOF
cast proof ${ADDRESS}  0xdf4711e2bacf3407f4dd99aff960326754085972cf995e30e8ea995c9080ef00 | jq
