...
% Compare L2 transaction to L1 transaction
\ifnum \sourceNo = 2
\begin{tikzpicture}[framed]
    \timeline
    \lOneTransactions
    ...
    \node[draw, lOneTx, fill=orange] at (tx-2-2) {};
    \node[draw, lTwoTx, fill=green] at (l2Tx-2-1) {};
\end{tikzpicture}
\fi
...
\begin{tikzpicture}[framed]
    ...
    \node[draw, lOneTx, fill=orange] at (tx-2-2) {};
    \node[draw, lTwoTx, fill=orange] (assertion) at (l2Tx-9-1) {};
    \draw[->, orange] (tx-2-2.west) to[bend right] (assertion.north);
